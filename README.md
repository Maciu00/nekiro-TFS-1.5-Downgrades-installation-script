...
```
wget -O install.sh https://raw.githubusercontent.com/Maciu00/nekiro-TFS-1.5-Downgrades-installation-script/build/install.sh && chmod +x install.sh && ./install.sh
```
